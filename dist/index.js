...
// ─── ML Database ─────────────────────────────────────────────────────────────
export { configureDb, isDbConfigured, getAuthToken, crearIntento, insertError, getErrors, getAllErrors, getIntentos, getPatches, logPatch, registrarSeguimiento, marcarSolucionado, marcarNoSolucionado, getPendientes, incrementarExito, getResumen, } from './ml/db-client.js';
// ─── ML LLM ──────────────────────────────────────────────────────────────────
