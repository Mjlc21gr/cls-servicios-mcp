...
import type { ShellConfig, ShellAppArtifact, RemoteRoute } from '../types.js';
 ...
 */
export function generateShellApp(config: ShellConfig): ShellAppArtifact {
...
function generateAppRoutes(remotes: RemoteRoute[]): string {
  const lines: string[] = [];
...
function generateFederationConfig(remotes: RemoteRoute[]): string {
  const lines: string[] = [];
...
function generateAppComponent(appName: string): string {
  return [
...
function generateCspMeta(remotes: RemoteRoute[]): string {
