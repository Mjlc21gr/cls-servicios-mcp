import { ValidationResult, ValidationError, SecurityWarning } from '../types.js';
 ...
 */
const WARNING_PATTERNS: { pattern: RegExp; name: string; message: string }[] = [
  {
 ...
 */
export function validateInput(sourceCode: string): ValidationResult {
